...
func (*CreateTokenRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*CreateTokenResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*CheckTokenRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*CheckTokenResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func (*ExtendTokenRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func (*ExtendTokenResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{5} }
...
func (*UpdateAccessRequestElement) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{6} }
...
func (*UpdateAccessRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{7} }
...
func (*GetUserTokensRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{8} }
...
func (*GetUserTokensResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{9} }
...
func (*DeleteTokenRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{10} }
...
func (*DeleteUserTokensRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{11} }
...
func init() { proto.RegisterFile("auth/auth.proto", fileDescriptor1) }
