...
func (*StoredToken) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*AccessObject) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*ResourcesAccess) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*StoredTokenForUser) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func init() { proto.RegisterFile("auth/auth_types.proto", fileDescriptor0) }
