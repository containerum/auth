...
var (
	...
	*/
	...
	JWTSigningMethodFlag = cli.StringFlag{
		...
		EnvVars: []string{"JWT_SIGNING_METHOD"},
		Value:   "HS256",
	}
	...
	JWTSigningKeyFileFlag = cli.StringFlag{
		...
		EnvVars: []string{"JWT_SIGNING_KEY_FILE"},
	}

	JWTValidationKeyFileFlag = cli.StringFlag{
		Name:    "jwt_validation_key_file",
		EnvVars: []string{"JWT_VALIDATION_KEY_FILE"},
	}
	...
	*/
	...
	HTTPListenAddrFlag = cli.StringFlag{
		...
		EnvVars: []string{"HTTP_LISTENADDR"},
		Value:   ":8080",
	}

	GRPCListenAddrFlag = cli.StringFlag{
		Name:    "grpc_listenaddr",
		EnvVars: []string{"GRPC_LISTENADDR"},
		Value:   ":8888",
	}
